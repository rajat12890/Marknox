            ...
            <div className="lg:w-[1200px] md:mx-auto h-full border-x border-gray-100 dark:border-gray-800 bg-[#ffffff] dark:bg-[#1c1a1b]">
                ...
                <div className="pb-28 pt-24 sm:pt-28 md:pt-44 flex px-6 md:px-24">
                    <div className="self-center">
                        <img src={"https://www.w3schools.com/howto/img_avatar.png"} className="rounded-xl w-28 h-38 mb-6  lg:hidden" />
                        <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
                            <div className="lg:w-[80%] text-gray-900 dark:text-gray-200 self-center">
                                ...
                                <div className="flex gap-2 mt-6">
                                    <a href="#projects" className="px-6 py-3 border border-gray-900 dark:border-gray-100  hover:text-red-500 hover:font-bold hover:border-none hover:rounded-lg rounded transition-all hover:text-gray-100 duration-300">Projects</a>
                                    <a href="#contact" className="px-6 py-3 hover:text-cyan-400 hover:text-md transition-all duration-300 flex gap-3 hover:gap-4">
                ...
                <div className="flex flex-wrap lg:flex-nowrap  font-medium  justify-between gap-12 mt-20 md:px-16">
                   
                    <div>
                        <div className="p-6 font-medium  hover:bg-gray-50 transition-all duration-300 hover:dark:bg-[#101e38] md:rounded-xl">
                            <h4 className="text-lg font-medium text-gray-600 dark:text-gray-300">Programming Languages</h4>
                            <p className="leading-7 mt-2 text-base font-light font-medium   text-gray-500 dark:text-gray-300">{info.skills.languages.description}</p>
                        ...
                        <div className="p-6 hover:bg-gray-50 transition-all duration-300 hover:dark:bg-[#101e38] md:rounded-xl">
                            ...
                            <p className="leading-7 mt-2 text-base font-light text-gray-500 font-medium  dark:text-gray-300">{info.skills.frameworks.description}</p>
